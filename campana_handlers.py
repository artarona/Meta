...
def get_bot_response_campana(text, user_id):
    ...
    # ========== VENDER (QUIERO VENDER) - FLUJO SECUENCIAL ==========
    ...
    elif paso_actual == 'vender_paso_disponibilidad':
